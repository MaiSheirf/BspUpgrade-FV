package com.bsp.upgrade.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.bsp.upgrade", transactionManagerRef = "transcationManager", entityManagerFactoryRef = "entityManager")
...
public class DynamicDatabaseRouter {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource()).packages("com.bsp.upgrade").build();
    }
